...
orderlines_tbl <- read_excel("01_bike_sales/01_raw_data/orderlines.xlsx")
bikeshops_tbl  <- read_excel("01_bike_sales/01_raw_data/bikeshops.xlsx")
...
bike_orderlines_wrangled_tbl %>%
  write_xlsx("02_bike_sales/bike_orderlines.xlsx")

# 7.2 CSV ----
bike_orderlines_wrangled_tbl %>% 
  write_csv("02_bike_sales/bike_orderlines.csv")

# 7.3 RDS ----
bike_orderlines_wrangled_tbl %>% 
  write_rds("02_bike_sales/bike_orderlines.rds")